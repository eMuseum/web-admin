...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<center>
			<h1> Gestionar Obres </h1>
			<?php 
				if(isset($_GET["err"])){
					$err = $_GET["err"];
					if($err == "21"){ 
							echo "<font color=\"blue\"> Obra eliminada! </font>";
					}else if($err = 24){
						echo "<font color=\"red\"> No has sel·leccionat cap obra! </font>";
					}
				}
			?>
			<div id='Formulari'>
				<form method="post" action="php/serv_gest_canvis_o.php">
					<div id='scroll_m'>
						<?php
							include "php/dbCon.php";
							$query = mysql_query("SELECT * FROM `e_obres`");
				...
				<br><input type="submit" id="button_m" name="subirBtn"  style="margin-left:50px; margin-top:10px; background-color:red;" value="Borrar Obra" />
				</div>
