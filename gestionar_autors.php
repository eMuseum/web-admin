...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<center>
			<h1> Gestionar Autors </h1>
			<?php 
				if(isset($_GET["err"])){
					$err = $_GET["err"];
					if($err == "21"){ 
							echo "<font color=\"blue\"> Autor Eliminat! </font>";
					}else if($err = 24){
						echo "<font color=\"red\"> No has sel·leccionat cap autor! </font>";
					}
				}
			?>
			<div id='Formulari'>
				<form method="post" action="php/serv_gest_canvis_a.php">
					<div id='scroll_m'>
						<?php
				...
				<br>
					<input type="submit" id="button_m" name="subirBtn"  style="margin-top:10px; background-color:red; margin-left:50px;" value="Borrar Autor" />
				</div>
